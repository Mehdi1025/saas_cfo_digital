        ...
        @else
            <main style="min-height:100vh;display:grid;place-items:center;padding:2rem;background:#f8fafc;color:#0f172a;">
                <section style="max-width:42rem;background:white;border:1px solid #e2e8f0;border-radius:1rem;padding:2rem;box-shadow:0 10px 30px rgba(15,23,42,.08);">
                    ...
                    <h1 style="margin:0 0 1rem;font-size:1.75rem;line-height:1.2;">Les assets front ne sont pas encore g�n�r�s.</h1>
                    <p style="margin:0 0 1rem;font-size:1rem;line-height:1.7;color:#334155;">Le serveur Laravel fonctionne, mais l'interface React/Inertia n'est pas encore compil�e. Lancez le front une fois pour terminer l'installation locale.</p>
