...
use App\Http\Controllers\Auth\EmailVerificationCheckController;
...
Route::middleware(['guest', 'cache.headers:private;no_store;must_revalidate'])->group(function () {
...
Route::get('confirmer-email/{id}/{hash}', VerifyEmailController::class)
...
Route::middleware('auth')->group(function () {
    ...
    Route::get('email-verifie', EmailVerificationCompleteController::class)
        ->middleware('verified')
