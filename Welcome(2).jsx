...
import CopifiBrandLogo from '@/Components/Copifi/CopifiBrandLogo';
import CopifiAwwwardsLogo from '@/Components/Copifi/CopifiAwwwardsLogo';
    ...
    return (
        <>
            <Head>
                ...
                />
                <meta property="og:title" content="Copifi — Facturez, pilotez, décidez" />
                <meta
            ...
            <div id="ff-landing" className="relative min-h-screen overflow-x-clip bg-[#050505] text-white selection:bg-emerald-500 selection:text-black">
                ...
                <footer className="relative z-10 border-t border-white/10 bg-[rgba(0,0,0,0.65)] py-10">
                    <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-6 px-6 md:flex-row">
                        <CopifiBrandLogo variant="white" size="sm" />
