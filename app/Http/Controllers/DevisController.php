...
class DevisController extends Controller
{
    ...
    private function validateDocument(Request $request, ?Document $document = null): array
    {
        return $request->validate([
            ...
            'type_prestation' => ['required', Rule::in([DocumentPrestation::TYPE_SERVICE, DocumentPrestation::TYPE_PRODUIT])],
            'destination' => ['nullable', 'string', 'max:255', 'required_if:type_prestation,produit', Rule::exists('delivery_destinations', 'name')],
            'jours_stockage' => ['nullable', 'integer', 'min:0', 'required_if:type_prestation,produit'],
